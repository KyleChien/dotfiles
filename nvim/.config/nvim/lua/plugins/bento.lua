return {
  ...
  --   max_open_buffers = 10, -- Max buffers (nil = unlimited)
  --   buffer_deletion_metric = "recency_access", -- Metric for buffer deletion (see below)
  ...
  --       max_rendered_buffers = 10, -- nil (no limit) or number for pagination
  --     },
  --     tabline = {
